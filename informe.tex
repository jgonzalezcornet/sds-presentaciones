...
En la Fig. 1 se presenta la evolución de la polarización en función del tiempo para el escenario base sin partícula líder. Para determinar el instante a partir del cual se considera que el sistema alcanza el estado estacionario, se realizaron una serie de simulaciones recorriendo distintos valores de ruido, como se muestra en la Fig. 1. A partir de la visualización de la polarización en función del tiempo para el valor máximo de ruido, se identificó el instante en el cual cinco mediciones consecutivas de la polarización presentan variaciones relativas inferiores a una cierta tolerancia. De este modo, el valor obtenido resulta aplicable para todos los valores de ruido menores, ya que se observó que, a mayor valor de $\eta$, mayor es el tiempo requerido para alcanzar el estado estacionario.
...
La Fig. 3 exhibe el comportamiento temporal para el escenario que incorpora un líder con dirección fija.
